...
def read_and_process_data(input_path: str, train: Output[Dataset], test: Output[Dataset]):
    """ Will read the dataset from GCP Bucket and validate with Evidently
        :param input_path: The FUSE FS path to a .csv file containing the data which the model will be trained
