from kfp.v2.dsl import Dataset, Output, component, Input, Metrics, Model, Artifact
...
def deploy_model(
    ...
    def create_endpoint(project: str = project, region: str = region) -> str:
        """ Will list endpoints in the region and update it for the current model in case of deployment 
            :param project: GCP Project for this operation
            :para regio: GCP Region for this operation """
    ...
    model_upload = aiplatform.Model.upload(
        ...
        serving_container_health_route=f"/healthcheck",
